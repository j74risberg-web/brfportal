  ...
  return (
    <div className="app">
          ...
          {active === "Nyheter" && (
            <div className="card news-card">
              <div className="carousel">
                <img src={news[newsIndex].image} alt="Nyhet" />
                <div className="nav">
      ...
      <style jsx>{`
        ...
        .login-screen { height: 100vh; display: flex; align-items: center; justify-content: center; background-color: #f1f5f9; background-image: radial-gradient(at 0% 0%, hsla(145,28%,66%,0.3) 0, transparent 50%), radial-gradient(at 50% 0%, hsla(205,33%,71%,0.3) 0, transparent 50%); }
