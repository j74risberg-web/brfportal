    ...
    <main className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-white">
      <div className="flex flex-col items-center justify-center p-8 md:p-12 relative">
        <div className="w-full max-w-md">
          {/* Logo-del som matchar din dashboard */}
          ...
          <div className="mb-8">
            <h2 className="text-3xl font-black uppercase tracking-tighter italic mb-2">Välkommen hem</h2>
            <p className="text-zinc-500 text-xs font-bold uppercase tracking-widest">
              Logga in för att boka tvättstuga eller bastu
            </p>
          </div>
          ...
          <SignIn 
            appearance={{
              elements: {
                ...
                socialButtonsBlockButtonText: "font-black uppercase tracking-widest text-[9px] text-zinc-600",
                formFieldInput: "bg-zinc-50 border-zinc-200 rounded-none p-4 text-sm",
                footerAction: "hidden", // Viktigt: Döljer "Sign up" för att tvinga inbjudan
                dividerRow: "my-6",
              }
            }}
          />
      ...
      {/* Bildsidan - använder husbilden som i din hero */}
